...
- Сервер со **Statamic**
- Одна учетная запись **Netlify**, где у меня есть окончательная статическая версия сайта
- Еще одна бесплатная учетная запись **Netlify**, где у меня есть версия SSR
- И, конечно же, **Buddy**, чтобы автоматизировать все это.
